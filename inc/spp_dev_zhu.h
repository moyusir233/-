...
#define PERC_COUNTER_MAX 127 //-16 to +15: 5 bits counter //7 bits -128 - 127
// #define PERC_THRESHOLD_HI  -85
// #define PERC_THRESHOLD_LO  -120
// #define POS_UPDT_THRESHOLD  450
// #define NEG_UPDT_THRESHOLD -400
// #define PERC_THRESHOLD_HI  -15
// #define PERC_THRESHOLD_LO  -45
// #define POS_UPDT_THRESHOLD  270
// #define NEG_UPDT_THRESHOLD -240
#define PERC_THRESHOLD_HI  -25
#define PERC_THRESHOLD_LO  -75
#define POS_UPDT_THRESHOLD  450
#define NEG_UPDT_THRESHOLD -400
...
class PERCEPTRON {
  public:
	...
	PERCEPTRON() {
        ...
        // PERC_DEPTH[0] = 4096;   //base_addr;
        // PERC_DEPTH[1] = 4096;   //cache_line;
        // PERC_DEPTH[2] = 4096;  	//page_addr;
        // PERC_DEPTH[3] = 4096;   //confidence ^ page_addr;
        // PERC_DEPTH[4] = 4096;	//curr_sig ^ sig_delta;
        // PERC_DEPTH[5] = 4096; 	//ip_1 ^ ip_2 ^ ip_3;
        // PERC_DEPTH[6] = 4096; 	//ip ^ depth;
        // PERC_DEPTH[7] = 4096;   //ip ^ sig_delta;
        // PERC_DEPTH[8] = 4096;   	//confidence;
